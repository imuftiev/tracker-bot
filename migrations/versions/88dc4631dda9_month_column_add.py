...
Revision ID: 88dc4631dda9
Revises: ba26d18663a5
Create Date: 2025-06-30 11:53:06.631954
...
revision: str = '88dc4631dda9'
down_revision: Union[str, Sequence[str], None] = 'ba26d18663a5'
...
def upgrade() -> None:
    ...
    op.add_column('events', sa.Column('month', sa.ARRAY(sa.Integer()), nullable=True))
